...
public class CommandUsingRequestCache extends HystrixCommand<Boolean> {
    ...
    protected Boolean run() {
    	System.out.println("run:"+value+","+Thread.currentThread().getName());
        return value == 0 || value % 2 == 0;
    }

    @Override
    protected String getCacheKey() {
    	System.out.println("getCacheKey:"+value+","+Thread.currentThread().getName());
	...
	public static class UnitTest {
        ...
        public void testWithoutCacheHits() {
            ...
            try {
            	 ...
            	 CommandUsingRequestCache cc=new CommandUsingRequestCache(2);
                 assertTrue(cc.execute());
                 System.out.println(cc.isResponseFromCache);
                 /*assertTrue(new CommandUsingRequestCacheB(10).execute());
                 assertTrue(new CommandUsingRequestCacheB(58664).execute());*/
            } finally {
                context.shutdown();
            }
            CommandUsingRequestCache cc=new CommandUsingRequestCache(2);
            assertTrue(cc.execute());
            //System.out.println(cc.isResponseFromCache);
          /*  CommandUsingRequestCache c=new CommandUsingRequestCache(41);
            c.execute();*/
            //assertFalse(c.isResponseFromCache);
